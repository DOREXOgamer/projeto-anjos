...
router.post(
  ...
  async (req: AuthRequest, res) => {
    ...
    await createAuditLog(
      ...
      "CREATE",
      "announcement",
      `Criou o aviso mural: ${data.title}`,
      id
    )
...
router.put(
  ...
  async (req: AuthRequest, res) => {
    ...
    if (data.body !== undefined) updateRow.content = data.body
    if (data.attachments !== undefined) updateRow.attachments = data.attachments
    ...
    await createAuditLog(
      ...
      "UPDATE",
      "announcement",
      `Atualizou o aviso mural: ${data.title || existingAnn.title}`,
      id
    )
